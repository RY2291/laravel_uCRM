...
const fetchAddress = () => {
  new YubinBango(String(form.postcode), (value) => {
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="date" id="birthday" name="birthday" v-model="form.address"
                                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                  ...
                                                  <label for="gender1" class="leading-7 text-sm text-gray-600 ml-4 mr-2">男性</label>
                                                  <input type="radio" id="gender1" name="gender" v-model="form.gender" value="0">
                                                  <label for="gender2" class="leading-7 text-sm text-gray-600 ml-4 mr-2">女性</label>
                                                  <input type="radio" id="gender2" name="gender" v-model="form.gender" value="1">
                                                  <label for="gender3" class="leading-7 text-sm text-gray-600 ml-4 mr-2">その他</label>
                                                  <input type="radio" id="gender3" name="gender" v-model="form.gender" value="1">
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
