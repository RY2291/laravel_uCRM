                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <label for="is_selling" class="leading-7 text-sm text-gray-600 ml-4 mr-2">販売中</label>
                          <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1">
                          <label for="is_selling" class="leading-7 text-sm text-gray-600 ml-4 mr-2">停止</label>
